...
$sql_pro="SELECT * FROM tbl_product WHERE tbl_product.product_name LIKE '%".$tukhoa."%' ";
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-11 offset-lg-1">
                <h4 style="margin-top:20px;margin-left:-40px">Từ khóa tìm kiếm:  <?php echo $_POST['tukhoa']?></h4>
                <div class="row">
                    <?php
